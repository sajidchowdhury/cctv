      ...
      try {
        ...
        setLines(
          (purchase.items as any[]).map((it) => ({
            ...
            productModel: it.productModel ?? products.find((p) => p.id === it.productId)?.model ?? null,
                ...
                <div key={line.key} className="rounded-lg border p-3 space-y-3">
                  <div className="flex items-start justify-between gap-2">
                    <div className="min-w-0">
                      ...
                      {line.productModel && <p className="text-xs text-muted-foreground">{line.productModel}</p>}
